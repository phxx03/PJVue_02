    ...
    <ion-page>
        <ion-header mode="ios">
            <ion-toolbar color="secondary">
                ...
                <ion-title>แก้ไขข้อมูลพนักงาน</ion-title>
            </ion-toolbar>
        </ion-header>

        <ion-content>
            <ion-searchbar mode="ios" placeholder="ค้นหาพนักงาน"></ion-searchbar>
            <ion-card>
                    ...
                    <div class="ion-no-margin">
                        <ion-card color="tertiary" class="ion-no-padding border-radius">
                            <ion-item button class="ion-margin-bottom" color="tertiary" lines="full"
                                v-for="ticket in tlist" :key="ticket.go" routerLink="/edit-Employee-Detail">
