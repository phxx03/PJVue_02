            ...
            <ion-card>
                <ion-card-content color="tertiary">
                  ...
                  <ion-row>
                    <ion-col size="7">
                      <ion-label>
                        <h2><b><ion-textarea placeholder="ชื่อลูกค้า"></ion-textarea></b></h2>
                        <h3><ion-textarea placeholder="เบอร์"></ion-textarea></h3>
                      </ion-label>
                    </ion-col>
                    <ion-col>
                        <ion-list>
                            <ion-radio-group :allow-empty-selection="true" value="turtles">
                                <ion-item>
                                    <ion-label>รับเอง</ion-label>
                                    <ion-radio slot="end" value="dogs"></ion-radio>
                                </ion-item>

                                <ion-item>
                                    <ion-label>จัดส่ง</ion-label>
                    ...
                    <ion-row>
                        <ion-col>
                            <ion-textarea placeholder="ที่อยู่"></ion-textarea>
                        </ion-col>
                    </ion-row>
                    <ion-row>
                        <ion-col size="7">
            ...
            <ion-card>
                <ion-card-content color="tertiary">
                            ...
                            <ion-item button class="ion-margin-bottom" color="tertiary" lines="full"
                                ...
                                <ion-label>
                                    ...
                                    <ion-text color="medium">
                                        <h3>{{ ticket.gtime }} x 1</h3>
                                    </ion-text>
                                </ion-label>
                                <ion-label slot="end">
                                    <ion-text> {{ ticket.gtime }} </ion-text>
                                </ion-label>
                            </ion-item>
                        </ion-card>
                    </div>
                   ...
                   <ion-row>
                      <ion-col size="6" >
                        <div class="BT1">
                            <ion-button color="danger" class="ion-no-margin" expand="full" @click="() => router.push('/cast')">ลบ</ion-button>
                        </div>
                      </ion-col>
                      <ion-col size="6" >
                        <div class="BT1">
                            <ion-button color="success" class="ion-no-margin" expand="full" @click="() => router.push('/cast')">ยืนยัน</ion-button>
                        </div>
                      </ion-col>
                    </ion-row>
    </ion-page>
