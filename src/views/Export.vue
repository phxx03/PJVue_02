    ...
    <ion-page>
        <ion-header mode="ios">
            <ion-toolbar color="secondary">
                ...
                <ion-title>การจัดส่ง</ion-title>
            </ion-toolbar>
        </ion-header>

        <ion-content>
            <ion-searchbar mode="ios" placeholder="ค้นหา Order"></ion-searchbar>
            <ion-card>
                    ...
                    <div class="ion-no-margin">
                        <ion-card color="tertiary" class="ion-no-padding border-radius">
                            <ion-item button class="ion-margin-bottom" color="tertiary" lines="full"
                                v-for="ticket in tlist" :key="ticket.go" routerLink="/Export-Detail">
...
import { tickets } from "../mocks/Export"
